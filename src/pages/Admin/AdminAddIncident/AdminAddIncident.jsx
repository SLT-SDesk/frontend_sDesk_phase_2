...
const AdminAddIncident = () => {
  ...
  return (
    <div className="AdminAddInicident-main-content">
      <div className="AdminAddInicident-direction-bar">
        Incident {">"} Add Incident
      </div>

      {renderStatusMessage()}

      <div className="AdminAddInicident-content2">
        {" "}
        <AffectedUserDetails
          formData={formData}
        ...
        <div className="AdminAddInicident-submit-button-container">
          <button
            type="submit"
            className="AdminAddInicident-submit-button"
...
export default AdminAddIncident;